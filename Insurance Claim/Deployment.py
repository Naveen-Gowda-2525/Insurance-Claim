...
def user_input_features():
    ...
    Age = st.sidebar.selectbox('Age',('70 or older','50 to 69','30 to 49','18 to 29','0 to 17'))
    ...
    Surg_Description = st.sidebar.selectbox('Surg_Description',('Medical','Surgical','Not Applicable'))
