...
def user_input_features():
    ...
    Age = st.sidebar.number_input('Insert 0->(70 or older),1->(50 to 69),2->(30 to 49),3->(18 to 29),4->(0 to 17)')
    ...
    Surg_Description = st.sidebar.number_input("enter 0 ->Medical,1->Surgical,2->Not Applicable")
...
st.header("**Presented by Group 7:**")
st.markdown("**NAVEEN,SURAJ**")
